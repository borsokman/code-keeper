...
@patch("app.consumer.db")
def test_callback_validation_error_drops_poison_message(mock_db, mock_app, mock_pika_components):
...
@patch("app.consumer.db")
def test_callback_database_error_triggers_requeue(mock_db, mock_app, mock_pika_components):
